      ...
      <main>
...

        {
          weather && weather.map((w, index) =>{
            return(
              <Wrapper bgImage={ data.main.temp.toFixed() < 0 || w.main=="Snow" ? "/alora-griffiths-HlnFco4i624-unsplash.jpg" : w.main=="Rain" || w.main=="Thunderstorm" ? "/nick-nice-ve-R7PCjJDk-unsplash.jpg" : w.main=="Clouds" ? "/johny-goerend-z_SXPzTMKkc-unsplash.jpgg" : "/kenrick-mills-MF9Wy1NA55I-unsplash-2.jpg"} key={index}>
